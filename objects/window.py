from tkinter import *
class Window:
    def __init__ (self, root, title="New windwo", size=[1920, 1080], buttons=[], path_background_img="", rectangles=[]):
        self.root = root
        ...
        for coords in rectangles:
            ...
            inner_canvas = Canvas(self.root, width=canvas_size[0], height=canvas_size[1])
            self.inner_canvases.append(inner_canvas)
